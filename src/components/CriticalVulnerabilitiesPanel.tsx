...
const CriticalVulnerabilitiesPanel: React.FC<CriticalVulnerabilitiesPanelProps> = ({ 
  ...
  const totalPages = Math.ceil(criticalVulnerabilitiesCount.length / ITEMS_PER_PAGE);
          ...
          <>
            <div className="space-y-3 mb-6">
              {paginatedVulnerabilities.map((vulnerability, index) => (
                <Alert key={`${vulnerability.name}-${vulnerability.host}-${index}`} className="border-destructive/20 bg-destructive/5">
